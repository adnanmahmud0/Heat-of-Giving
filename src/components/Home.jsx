...
import clothDonationImage from "../assets/cloth-donation-image.jpg";
                        ...
                        <div className="w-full flex justify-center items-center">
                            <div class=" text-center">
                                ...
                                <h1 class="text-4xl md:text-7xl font-bold text-white mb-6 animate__animated animate__bounce">
                                    There is no Big Thing <br /> Then Your Concern
                                </h1>
                                ...
                                <Link
                                    to="/HowToHelp"
                                    class="bg-[#4FC3F7] hover:bg-[#FFFFFF] text-white hover:text-black font-semibold text-lg py-3 px-8 rounded-full shadow-lg transition"
                                >
                                    How to Help
                                </Link>
                            </div>
                    ...
                    >
                        <div className="w-full flex justify-center items-center">
                            <div class=" text-center">
                                ...
                                <p class="text-sm text-gray-200 mb-8 animate__animated animate__bounce">
                                    Thousands across Bangladesh face the harsh cold. <br /> Together, we can make a difference.
                                </p>
                                <Link
